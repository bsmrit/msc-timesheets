            ...
            <form id="create-list-form" method="post" class="">
                ...
                <div class="d-flex justify-content-center form-row pt-2">
                    <div class="d-flex justify-content-between col-12 pl-0">
                        ...
                        <div class="form-check col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8 ml-1">
                            <div>
                                <input id="empl" class="form-check-input mt-2 mb-0" type="radio" name="admin" value="0" checked>
                                <label class="form-check-label mb-0 mt-1" for="empl">Set as employee</label>
                            </div>
                            <div>
                                <input id="admin" class="form-check-input mt-2 mb-0" type="radio" name="admin" value="1">
                                <label class="form-check-label mb-0 mt-1" for="admin">Set as admin</label>
                            </div>
                            <div>
                                <input id="recep" class="form-check-input mt-2 mb-0" type="radio" name="admin" value="2">
